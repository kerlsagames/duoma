...
- **Connect** — Lists, Notepad (shared pages, newest first, pin one, both of you can type the same note), Date Night Generator (400 ideas — spin or search, save to To-do, tick off, ask them tonight), Thought-of-You Pings, Talk, Audio Voice Notes (real microphone record & play), Gratitude Jar, Apology & Reset, Flirtatious findings (cheeky and taboo questions with your partner).
