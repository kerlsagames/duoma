...
- **Connect** — Lists, Date Night Generator (400 ideas — spin or search, save to To-do, tick off, ask them tonight), Thought-of-You Pings, Talk (10 decks, two topics each per day), Audio Voice Notes (real microphone record & play), Gratitude Jar, Apology & Reset, Flirtatious findings (cheeky and taboo questions with your partner).
- **Desire** — Get Spicy, Spark (200 slow-burn prompts — from afar or at home; favourite one, mark it completed), Dare Me (18 categories, 200 dares — heart a dare into To-do / Favourites), Roleplays (cartoon stills under each scene, heart to favourites), Positions (heart or save to To-do / Favourites, tick off, ask them tonight, or put it on Saturday’s calendar — search opens the action box on the pose you tap), The How (28 techniques in four parts: who does what, on which part of the body, a timed try, body-word translations, optional science speak), Fantasy Matcher (swipe deck, To-do, Completed, Passed), Intimacy Streak (the fire grows with dares, spicy nights, pings & Connect — daily connection score under the dates), The Sexy Vault (shared 4- or 6-digit pin, photo/video thumbs, swipe between them, full screen, optional hide-until).
