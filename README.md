...
- **Desire** — Get Spicy, Dare Me (18 categories, 200 dares), Roleplays (cartoon stills under each scene), Positions (save to To-do, tick off, ask them tonight), The How (a technique book: named moves, a weekly try, shared words, notes on what worked), Fantasy Matcher (swipe deck, To-do, Completed, Passed), Intimacy Streak (the fire grows with dares, spicy nights, pings & Connect), The Sexy Vault (shared pin, photo/video, optional hide-until).
