...
- **Desire** — Get Spicy, Dare Me (18 categories, 200 dares), Roleplays (cartoon stills under each scene), Positions (save to To-do, tick off, ask them tonight), The How (28 techniques in four parts — physiology, variations, a timed try, signs it’s working), Fantasy Matcher (swipe deck, To-do, Completed, Passed), Intimacy Streak (the fire grows with dares, spicy nights, pings & Connect), The Sexy Vault (shared pin, photo/video, optional hide-until).
