...
export const HOW_TECHNIQUES: HowTechnique[] = [
  tech(
    ...
    "10-minute start",
    [
      step("0 to 3", "Clear the space", "Lights down. Laptop off the bed. Phones face-down in another room. The bed is for bodies, not the day.", 180),
      step("3 to 6", "Breathe down", "She lies on her back. One of your hands on her chest, one on her belly. Ten slow breaths together, belly rises, chest stays quiet.", 180),
      step("6 to 8", "Say the job", "Out loud, one sentence: nowhere to rush, nothing to finish, no one owes an orgasm.", 120),
      step("8 to 10", "Start far away", "Slow palms on her arms, neck, or shoulders. Stay off breasts, vulva, and penis. You are not starting sex yet.", 120),
    ],
    "Ready when",
  ...
  tech(
    ...
    [
      ...
      kind("The freeze", "Speed the stroke up. Then stop dead, fingers still on her. Hold 3 to 5 seconds. Let her throb against a still hand."),
    ],
    "10-minute try",
    [
      step("0 to 4", "Same stroke", "Two lubed fingers. Slow up-and-down along the inner lips, beside the clitoris, not on the exposed tip, not inside her. Same path, same pressure, until she settles.", 240),
      step("4 to 6", "Jump", "Every 45 seconds, lift off the vulva and rest on her inner thigh or lower belly for 3 seconds. Then the exact same up-and-down.", 120),
      step("6 to 8", "Press", "On her exhale, plant a firm still palm on the mons (the mound above the clitoris) for 5 seconds. Then back to feather-light fingers on the inner lips.", 120),
      step("8 to 10", "Freeze", "Same stroke, a little faster. At the fastest beat, freeze. Fingers stay on her. Hold until she gasps or her hips twitch.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    [
      ...
      kind("Brush and leave", "One light half-second pass over the clitoral hood (the fold of skin covering the clitoris). Then 30 to 60 seconds back on her thighs."),
      kind("Through fabric", "Leave her underwear on. Circles with your palm or a toy over the cloth so the pressure spreads."),
    ],
    "10-minute try",
    [
      step("0 to 3", "Far away", "Palms on her lower back, hips, and outer thighs. Light fingertips on the inner thighs. Stay off the vulva.", 180),
      step("3 to 6", "Closer", "A warm still palm on the mons (the mound above the clitoris). Hover a finger over the outer lips so she feels heat, not contact. Do not land on the clitoris.", 180),
      step("6 to 8", "Brush", "Once a minute, one light pass over the clitoral hood. Lift off. Go back to thighs. Do not stay on it.", 120),
      step("8 to 10", "Land", "Now rest two fingers on the inner lips and just above the hood, the fold covering the clitoris. Steady contact. Still not on the raw tip, still not inside.", 120),
    ],
    "Ready when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Far", "Palms on her lower back, hips, and outer thighs. Skip the pelvis and skip the vulva.", 180),
      step("3 to 5", "Bones", "Warm still pressure on the mons and both hip bones. Hands do not rub. They rest.", 120),
      step("5 to 8", "Outer", "Lube on your palm. Glide up and down the outer lips and inner thighs. Stay off the clitoral tip.", 180),
      step("8 to 10", "Closer", "Two fingers in the inner lips. Then a slow circle on the clitoral hood, the fold of skin over the clitoris. Not on the raw tip. Not inside her.", 120),
    ],
    "Move on when",
  ...
  tech(
    ...
    [
      ...
      step("0 to 5", "Hands only", "First five minutes of direct vulva touch: her hand on yours. She moves your fingers. You copy.", 300),
      step("5 to 8", "One word", "Her hand comes off. You keep the last motion. She only speaks if something must change: lighter, stay, slower.", 180),
      step("8 to 10", "Body only", "If she is close, stop talking. Watch her hips and breath. Push-in means keep going. Pull-away means ease off, do not leave.", 120),
    ],
    "Working when",
    "Lighter. Stay.",
    voice(
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 2", "Pick one", "Lots of lube. Choose up-and-down along both sides of the clitoral hood. About one stroke a second. Stay off the raw tip.", 120),
      step("2 to 5", "A bit faster", "Same path, same two fingers, same pressure. Maybe 20% quicker. Do not wander onto the tip or inside her.", 180),
      step("5 to 8", "Hold it", "Do not change sides, speed, or shape. This boring minute is the one that builds.", 180),
      step("8 to 10", "Keep it", "If your hand tires, drive from the wrist or forearm so the contact on her hood never changes shape.", 120),
    ],
    "Stay or adjust",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Plain circle", "Lube. Two fingertips make a smooth 4-count circle around the clitoral hood. Even pressure. No extra press yet. Not on the raw tip.", 180),
      step("3 to 6", "Press on 1", "Same circle. Extra weight only at the top, toward the mons. Counts 2 to 4 stay light.", 180),
      step("6 to 8", "Move it", "Same pulse, now at the bottom of the circle, just below the clitoris, toward the opening. Still not inside.", 120),
      step("8 to 10", "Press and hang", "Keep the extra press, and add a half-second pause on that accent as she climbs. Path does not change.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    [
      ...
      kind("Back off", "Do not take your hand off her. Flatten your palm on the mons (the mound above the clitoris), or stroke her inner thighs, 20 to 40 seconds."),
    ...
    [
      ...
      step("2", "Second", "Rebuild with slow circles around the hood. She will climb faster. At 90%, lift to inner-thigh strokes for 30 to 45 seconds.", 210),
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Wide", "Lots of lube. Two fingers. Big slow circles around the whole vulva, about one circle every two seconds. Go around the clitoris. Do not land on it.", 180),
      step("3 to 6", "Tight", "Spiral in until you are circling the clitoral hood, the fold over the clitoris. Light to medium. Still around the tip, not on it.", 180),
      step("6 to 8", "Oval", "Lengthen the circle down each inner lip and across the opening without going inside.", 120),
      step("8 to 10", "Crescent", "Smaller, quicker arcs just across the top of the hood, 9 to 3 o’clock. If she winces, widen again.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "Layering try",
    [
      step("0 to 5", "Fabric", "Underwear stays on. Palm circles over the cloth, right over the clitoris. Build here. No bare skin yet.", 300),
      step("5 to 8", "Skin, then fold", "If you go skin-on-skin and she flinches, fold the outer lips over the clitoris and keep stroking that fold. Do not chase the tip.", 180),
      step("8 to 10", "After", "If she comes, do not touch the tip. Whole-hand cushion on the vulva, light weight, no rubbing.", 120),
    ],
    "Use this when",
  ...
  tech(
    ...
    [
      ...
      step("0 to 15s", "Downshift", "Hand stays. Broad still palm on the mons and whole vulva. No rubbing the tip.", 30),
      step("15 to 60s", "Sweep", "More lube. Soft wide circles on the far outer lips only. Skip the clitoris.", 90),
      step("1 to 3m", "In again", "If she can take it, spiral closer to the hood and a bit faster. If she flinches, stay wide.", 180),
      step("3 to 5m", "Second", "Hips pushing into your hand? Lock that stroke again and ride a second orgasm.", 120),
    ],
    "Safe to climb when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Set up", "Pillow under her hips. Lots of lube. Slow in until the head, toy, or fingertips press the front wall, the vaginal wall toward her belly, a couple of inches in. Not a slam to the cervix.", 180),
      step("3 to 6", "Short strokes", "One to two inches of movement. Stay in contact with that front wall. Do not piston through the middle of the canal.", 180),
      step("6 to 8", "Sides", "Without pulling out, 60 seconds aimed a little left, 60 seconds a little right. Notice which one makes her sound or grab you.", 120),
      step("8 to 10", "Lock it", "Stay on the best angle. Hips almost still. Short grind, not a long thrust. Hold it if she is climbing.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 2", "In and parked", "Comfortable full in. Slide your body forward until your pubic bone is on her mons and clitoris. Stay there.", 120),
      step("2 to 5", "Sway", "Slow side to side. Feel the vaginal walls, not more depth. The clitoris stays under your pubic bone.", 180),
      step("5 to 8", "Circles", "Small hip rolls, about an inch. The outside contact on her clitoris never leaves.", 180),
      step("8 to 10", "Weight", "Keep that downward press on the mons plus micro-rolls. If you start thrusting, you are doing a different card.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Inside first", "Slow penis, toy, or fingers inside only. Let her get wet and warm. No clitoral hand yet.", 180),
      step("3 to 5", "Add outside", "Lube on the clitoral hood. Gentle circles with two fingers. Do not speed up or change the inside stroke.", 120),
      step("5 to 8", "Match", "Same tempo inside the vagina and on the clitoris. If you have to drop one, drop the inside, not the hand.", 180),
      step("8 to 10", "Lock both", "Near the edge, freeze both: same inside depth, same finger circle. Do not drop the hand when she starts to come.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 2", "Just in", "One to two inches of penis, toy, or two fingers. Pause. Extra lube. Comfort first. Do not go deeper to ‘get to it.’", 120),
      step("2 to 5", "Up", "Firm up-pressure against the top of the opening. Slow one-inch slides, never dropping that lift. You are prying the doorway, not thrusting.", 180),
      step("5 to 8", "Sides", "Five short strokes pressing the left wall, five pressing the right. Stay shallow.", 180),
      step("8 to 10", "Drag out", "On the way out, keep the upward press so the head or fingers drag the front of the opening.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Tip only", "Lots of lube. First knuckle of a finger, or the first inch of penis or toy. All motion at the vaginal opening. Do not go looking for more room.", 180),
      step("3 to 6", "Glides", "Half an inch in to an inch and a half. The ring of muscle at the entrance is the whole job.", 180),
      step("6 to 8", "Plus up", "Same shallow glide, pressed up along the roof of the opening. Never past an inch and a half.", 120),
      step("8 to 10", "Flutter", "If she wants speed, quick little pulses at the rim. If she wants you deeper, she will pull you in. You do not decide that.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Strip the in-stroke", "Inward is a light reset, almost nothing. All the meaning is on the way out, dragging the front wall and the opening.", 180),
      step("3 to 6", "Uneven timing", "Three seconds in, one second out with that drag. She should be waiting for the exit, not the thrust.", 180),
      step("6 to 8", "Hook", "Every exit pulls up along the front wall and the front of the opening, toward her belly, until you almost leave.", 120),
      step("8 to 10", "Pause", "One-second stop at the exit each time, head or fingers still kissing the opening.", 120),
    ],
    "Working when",
    "Slow in. Drag out.",
    voice(
  ...
  tech(
    ...
    "Adding try",
    [
      step("0 to 4", "One", "One finger, slow, pad toward her belly. Wait until she is clearly wet and the opening is not fighting you.", 240),
      step("4 to 6", "Two", "Pause. Extra lube. Second finger in beside the first. Hold still 30 seconds. Do not pump.", 120),
      step("6 to 8", "Fill, don’t pump", "Tiny rocks or a slight angle toward the belly. No in-and-out required. Let her feel the stretch.", 120),
      step("8 to 10", "Stay wide", "Keep both fingers. Steady press toward the belly if she likes it. If she tenses, go back to one.", 120),
    ],
    "Safe when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Just breath", "No genital touch yet. One hand on her chest, one on her belly. Four seconds in through the nose, six out through the mouth.", 180),
      step("3 to 6", "Match", "Now two fingers, slow circles on the clitoral hood. Inhale as you press, exhale as you ease. If you are already inside, in on the in-stroke, out on the out-stroke, stay slow.", 180),
      step("6 to 8", "Longer sighs", "Exhales 6 to 8 seconds. Keep the same circles or a slow rock. Do not speed up because it feels good.", 120),
      step("8 to 10", "Hold", "Deep inhale on the climb, two-second hold at the strongest press, slow out. Fingers stay on the hood.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    [
      ...
      kind("Fast then nothing", "Up to 85 to 90% on the hood, then one still, light (or cool) contact for 30 seconds. Hand stays on her."),
    ],
    "10-minute try",
    [
      step("0 to 3", "Warm and smooth", "Warm lube. Two fingers, slow circles on the clitoral hood. Stay around 70%, climbing, not rushing the orgasm.", 180),
      step("3 to 5", "Stop and cool", "At about 85%, halt the circles. Cool breath or a cool clean object on the hood or inner thighs for 30 seconds. Do not leave her body.", 120),
      step("5 to 7", "Different texture", "Come back with a slightly firmer or more textured stroke on the hood, up toward 90%. Same place.", 120),
      step("7 to 8", "Still palm", "Stop. Warm open hand on the mons, 45 seconds. No rubbing.", 60),
      step("8 to 10", "Through", "Warm, wet, fast enough circles on the hood. Let the orgasm happen. Do not switch texture mid-clench.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "No genitals", "Hands on her neck, lower back, inner arms, inner thighs. Find the non-genital spot that makes her breath change. Stay off the vulva.", 180),
      step("3 to 6", "Hold the winner", "Steady warm pressure on that best spot, often the sacrum, just above the tailbone. Other hand still off the clitoris.", 180),
      step("6 to 8", "Add the clit", "Keep that first hand exactly where it is. Other hand: slow circles on the clitoral hood. Not inside her.", 120),
      step("8 to 10", "Same beat", "Both hands, same tempo. If she wants to come, ride it. Do not leave the lower-back hand to ‘help’ the clitoris.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "Voice try",
    [
      step("0 to 2", "Unlock the jaw", "Before you touch the vulva: mouth open, three deep sighs. Check her jaw is not clamped.", 120),
      step("2 to 5", "Hum", "Two fingers, slow circles on the clitoral hood. She hums a low ‘mmm’ for five seconds on every exhale.", 180),
      step("5 to 8", "Open", "Same circles. Switch to an open ‘ah.’ Teeth do not touch. If the sound stops, the pelvic floor is usually clamping, ease the stroke.", 180),
      step("8 to 10", "Let it", "Sound can get louder through a peak. That is a valve, not a performance. Keep the same stroke on the hood.", 120),
    ],
    "Working when",
  ...
  tech(
    ...
    "After try",
    [
      step("0 to 30s", "Freeze", "The second the contractions finish: stop rubbing. Full palm on the vulva. Do not pull away. Do not keep circling the clitoris.", 30),
      step("0.5 to 3m", "Hold", "Hand still. Slow belly breaths together. If she twitches, that is leftover pulse, stay still.", 150),
      step("3 to 6m", "Around", "Lift off the clitoris. Light strokes on inner thighs and hip bones only.", 180),
      step("6 to 10m", "Again or rest", "If a second wave shows up, hips pushing in, warm throb instead of sting, tiny circles on the hood. If not, stay in the hold. Do not go inside unless she asks.", 240),
    ],
    "Done well when",
    ...
    voice(
      ...
      ["No sharp drop-off.", "Pelvis stays engorged and easy for 10 to 15 minutes."]
    )
  ),
  tech(
    26,
    ...
    "10-minute try",
    [
      step("0 to 3", "Around first", "Lube on the clitoral hood. Broad circles around the clitoris, not on the exposed tip. Let the tissue swell.", 180),
      step("3 to 6", "On the hood", "One or two strokes a second on the hood. Add pressure only as she swells. If she winces, go back to around it.", 180),
      step("6 to 8", "Lock", "Same tempo, same millimetre of skin. No ‘helpful’ circles somewhere new.", 120),
      step("8 to 10", "Through", "When the pulsing starts, about once a second, including the anus, keep identical friction until it’s over. Then stop rubbing. Palm stays.", 120),
    ],
    "Close when",
  ...
  tech(
    ...
    "10-minute try",
    [
      step("0 to 3", "Warm first", "Do not start inside cold. Fingers or a mouth on the clitoris, or a long make-out, until she is clearly wet. Deep pressure on a cold vagina just aches.", 180),
      step("3 to 6", "Find the spongy bit", "One or two fingers, or a curved toy, 1.5 to 2 inches in, pads toward her belly. Slow upward presses, like saying ‘come here.’ Not toward the tailbone.", 180),
      step("6 to 8", "The pee feeling", "Common here, the urethral sponge sits next to that wall. Don’t panic, don’t stop unless she says. Long exhales. She softens the pelvic floor instead of clamping.", 120),
      step("8 to 10", "Stay", "Less sliding. Firm still pressure or tiny rocks on that same spongy spot until the wave is low and heavy. If she wants the clitoris too, add the other hand on the hood, do not abandon this press.", 120),
    ],
    "Close when",
  ...
  tech(
    ...
    "Blended try",
    [
      step("0 to 4", "Set up", "She’s already highly aroused from clitoral touch. Towel under her. Extra lube on the hood and on the fingers or toy going inside.", 240),
      step("4 to 7", "Both", "Two fingers inside, pads toward her belly, slow ‘come here’ press. Other hand: light steady circles on the clitoral hood. One shared beat. Do not pump the inside while the outside is climbing.", 180),
      step("7 to 9", "Let go", "Jaw soft, belly breath, no pelvic holding. If fluid comes, keep both hands moving unless she says stop. If she hates the pee feeling, ease the inside press and stay on the hood.", 120),
      step("9 to 12", "Stay", "After the first peak: half speed, lighter, 20 seconds still palm, then rebuild on the hood if she wants. Inside stays gentle or still, do not yank out.", 180),
    ],
    "Close when",
