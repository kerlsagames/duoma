...
export const COUPON_IDEAS: CouponIdea[] = [
  ...pack("food", [
    ...
    "Midnight toast bar: I make you whatever toast you want at whatever hour",
    "Bakery run before you wake: pastry on the bench, coffee how you like it",
    "Shared dessert, your spoon: I don't get a bite until you say",
    "Breakfast picnic on the floor: rug, plates, no table",
    "I order the thing you always want and never pick",
  ]),
  ...pack("relax", [
    ...
    "Ten-minute hand massage while a show plays",
    "I run the bath, you get the first soak, I keep the house quiet",
    "Shoulder rub in the doorway the second you get home",
    "I put on the playlist you like and don't talk for one album",
    "Fresh socks, warm, handed to you on the couch",
  ]),
  ...pack("chores", [
    ...
    "I empty the dishwasher before you notice it's full",
    "One weekend of bin night, all me",
    "I deal with the thing you've been putting off for a month",
    "Shoes by the door, sorted, without a speech",
    "I cook and clean so you never enter the kitchen tonight",
  ]),
  ...pack("outings", [
    ...
    "Night drive with no destination, one shared snack",
    "We try the new place you've been talking about",
    "Op shop date: twenty minutes, ten dollars, leave",
    "Lookout sit with a thermos, phones in the glovebox",
    "Walk until we find a bench we haven't sat on",
  ]),
  ...pack("flirty", [
    ...
    "Kiss in the kitchen like we just got home from a trip",
    "I tell you one specific thing I want later, then wait",
    "Hand on your lower back in a shop, no comment",
    "We slow-dance to one song before bed",
    "I leave a note on your pillow that isn't a joke",
  ]),
  ...pack("wildcard", [
    ...
    "I have to use a silly nickname you pick until tomorrow",
    "You get the good side of the couch for a week",
    "I do your weird snack combination without a face",
    "Skip the plan: we do nothing and I don't complain",
    "You pick the next three songs, even in the shop",
  ]),
  ...pack("escapes", [
    ...
    "Solo bath with the door shut and a lock if we have one",
    "I take the dog / the errand / the call so you can disappear for 40 minutes",
    "Headphones on, world off: I don't tap you unless the house is on fire",
    "You get the spare room or couch for a nap with a do-not-disturb",
    "I handle bedtime for everyone else so you can clock off early",
  ]),
  ...pack("nostalgia", [
    ...
    "We watch the movie you loved at sixteen, no commentary from me",
    "I find the cereal or lolly you swear they don't make anymore",
    "Photo album hour: you narrate, I don't skip ahead",
    "We recreate a meal from a holiday we actually took",
    "Old game on the TV, two controllers, no rushing me",
  ]),
  ...pack("relief", [
    ...
    "I sit with you in the car after a bad day. Engine off. No pep talk.",
    "You get to cancel tonight's plan. I rearrange it.",
    "I take the kids / the pets / the noise into another room for 20 minutes",
    "Shoulder squeeze and a glass of water, no questions",
    "I write down the thing that's stressing you so you can dump it",
  ]),
  ...pack("surprises", [
    ...
    "I put a sticky note on the bathroom mirror before you wake",
    "Your favourite snack appears in the fridge with no receipt talk",
    "I send a photo of something that made me think of you at lunch",
    "Car cleaned on a random Tuesday, keys back on the hook",
    "I queue your show and have the couch ready when you walk in",
  ]),
  ...pack("connection", [
