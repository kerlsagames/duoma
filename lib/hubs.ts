...
export const HOME_HEADER_WIDGETS = [
  {
    ...
    detail: "Mood, stress sync & what you need",
    ...
    features: [
      {
        ...
        detail: "Sizes, gifts, coffee orders, running lists",
        icon: "map",
        href: "/hub/lists",
      },
      {
      ...
      },
      {
        id: "jar",
        label: "The Jar",
        detail: "Gratitude & appreciation notes",
        icon: "file-tray",
        href: "/hub/jar",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        id: "up-for-it",
        label: "Up For It?",
        detail: "Intimacy availability signal",
        icon: "flash",
        href: "/hub/up-for-it",
      },
      {
      ...
      },
      {
        ...
        detail: "Opt-in swipe deck for desires",
        icon: "heart-circle",
      ...
      },
      {
        ...
        detail: "Protected folder for private audio",
        icon: "mic",
    ...
    features: [
      {
        id: "todos",
        label: "To-Do List",
        detail: "Shared household tasks & reminders",
        icon: "checkbox",
        href: "/hub/lists",
      },
      {
