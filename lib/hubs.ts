...
export const HUBS: HubDef[] = [
  {
    ...
    features: [
      ...
      {
        id: "open-when",
        label: "Open When… Envelopes",
        detail: "Notes locked until an emotional trigger",
        icon: "mail-open",
        href: "/hub/open-when",
        isNew: true,
      },
      ...
      },
      {
        ...
        detail: "Signal when you’re ready to ditch screens & cuddle",
        icon: "moon",
        href: "/hub/bedtime",
        isNew: true,
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        id: "up-for-it",
        label: "Intimacy Temperature",
        detail: "Private daily gauge for physical connection mood",
        icon: "thermometer",
        href: "/hub/up-for-it",
      },
      {
      ...
      {
        id: "slow-burn",
        label: "Slow-Burn Teasers",
        detail: "Countdowns with hidden text / blurred photos",
        icon: "timer",
        href: "/hub/slow-burn",
        isNew: true,
      },
      {
        id: "touch-map",
        label: "Touch Map",
        detail: "Body diagram for favorites, turn-ons & boundaries",
        icon: "hand-left",
        href: "/hub/touch-map",
        isNew: true,
      },
      {
        id: "consent-check",
        label: "Consent & Vibe Check",
        detail: "Check comfort levels before new ideas or roleplay",
        icon: "shield-checkmark",
        href: "/hub/consent-check",
        isNew: true,
      },
      {
        id: "secret-signals",
      ...
      {
        id: "aftercare",
        label: "Aftercare Reminders",
        detail: "Post-intimacy prompts for water, check-ins, cuddles",
        icon: "water",
        href: "/hub/aftercare",
        isNew: true,
      },
