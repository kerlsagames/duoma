...
const STEPS = [
  ...
  },
  {
    ...
    body: "Coupons, LoveBetz, photo memory (one shot a week — shuffle until you lock it), trivia, Draw It, Daily Word (same five letters, who lands it first), Fair Share (spin a chore or tap who did it last), and the rest of the games. Nothing here has to lead to bed.",
  },
  {
    kicker: "Home Base",
