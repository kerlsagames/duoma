...
const STEPS = [
  {
    ...
    body: "Email yourself a 6-digit code to open the app. On Home, Connect sends them the six-character pair code — that button leaves when they join. Forgot password on Home emails a sign-in link. Sign out does not unpair you. Do not make a new pair just to come back.",
  },
  {
    kicker: "Names",
  ...
  },
  {
    ...
    body: "Get Spicy, Dare Me, roleplays, positions, The How (named techniques, try one this week, keep the words that work), Fantasy Matcher, and The Sexy Vault. The vault uses a shared pin. You can hide a photo or clip until a time you set — they still get told something is waiting.",
  },
  {
    kicker: "Fun",
