...
const STEPS = [
  ...
  },
  {
    ...
    body: "Coupons, LoveBetz, photo memory (one shot a week), trivia, Draw It, Daily Word (same five letters, who lands it first), and the rest of the games. Nothing here has to lead to bed.",
  },
  {
    kicker: "Home Base",
