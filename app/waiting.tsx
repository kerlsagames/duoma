      ...
      <View className="flex-1 justify-between py-6">
        <View>
          ...
          <Text className="mt-2 text-[16px] leading-6 text-mist/65">
            Open Duoma on their phone — or another browser tab — and join with
            this code. You only do this once. After they join, the whole app is
            yours: home, calendar, games, spice.
          </Text>
        </View>
